...
const EditPage= ()=>{
    ...
    const updateProduct = async(e) =>{
        ...
        try{
            ...
            const  res = await axios.put(`${VITE_BACKEND_URL}/api/products/${id}`,product)
        ...
        <div className="max-w-lg bg-white shadow-lg mx-auto p-7 rounded mt-6">
            ...
            {isLoading ? ("isLoading") : (
                ...
                <div className="space-y-2">
                    ...
                    <div>
                        <label>Price</label>
                        <input type="text" value={product.price}  onChange={(e)=> setProduct({...product,price: e.target.value})} className="w-full block border p-3 text-gray-600 rounded focus:outline-none focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="Enter Price"/>
                    </div>
                    <div>
